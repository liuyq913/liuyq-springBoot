...
public class AopTypeDTXConfiguration {
    ...
    public BeanNameAutoProxyCreator beanNameAutoProxyCreator() {
        //指定 NativeDomain", "*Imp 结尾的bean来使用BeanNameAutoProxyCreator来创建对象， 先分布式事物切面， 后本地事物切面
        BeanNameAutoProxyCreator beanNameAutoProxyCreator = new BeanNameAutoProxyCreator();
        beanNameAutoProxyCreator.setInterceptorNames("txLcnInterceptor", "transactionInterceptor");
        beanNameAutoProxyCreator.setBeanNames("*NativeDomain", "*Imp");
